...
class SearchTitleFragment : SearchBaseFragment() {
    ...
    override fun resetData() {
        list = LitePal.where("account = ? and title like ?"
                , MailConstants.MAIL_ACCOUNT, key).order("sendTime desc").find(MailBean::class.java)
