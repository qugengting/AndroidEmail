...
class SearchSenderFragment : SearchBaseFragment() {
    ...
    override fun resetData() {
        list = LitePal.where("account = ? and sender like ? or senderAddress like ?"
                , MailConstants.MAIL_ACCOUNT, key, key).order("sendTime desc").find(MailBean::class.java)
